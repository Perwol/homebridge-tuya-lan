...
const STATE_OTHER = 9;
const fs = require('fs');
const statusNightModeFile = '/var/homebridge/WarmtecNightModeStatus';
const statusHumidityFile = '/var/homebridge/WarmtecHumidityStatus';
const statusTimerFile = '/var/homebridge/WarmtecTimerStatus';

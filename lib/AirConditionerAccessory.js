...
class AirConditionerAccessory extends BaseAccessory {
    ...
    getActive(callback) {
        this.getState('1', (err, dp) => {
            ...
            if (this.currentState == 0 && this.currentTimer > 0) {
                this.currentTimer = 0;
                fs.writeFile(statusTimerFile, this.currentTimer, function(err) {});
            }
    ...
    setRotationSpeed(value, callback) {
        ...
        if (value === 0) {
            ...
            if (this._hkRotationSpeed == value) {
                ...
                var dValue = this.convertRotationSpeedFromHomeKitToTuya(this._hkRotationSpeed);
    ...
    convertRotationSpeedFromTuyaToHomeKit(value) {
        ...
        var nValue = this._rotationStops[parseInt(value)];

...
const STATE_OTHER = 9;
const fs = require('fs');
const statusFile = '/home/pi/.homebridge/WarmtecNightModeStatus';
...
class AirConditionerAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        this.device.on('change', (changes, state) => {
            ...
            if (changes.hasOwnProperty('103')) {
                ...
                fs.writeFile(statusFile, this.nightModeStatus, function(err) {});
            }
        ...
        fs.watchFile(statusFile, { interval: 1000 }, (curr, prev) => {
            const nightModeReq = fs.readFileSync(statusFile);
            ...
            if (this.currentState == 0) {
                fs.writeFile(statusFile, 0, function(err) {});
                return;
            }
    ...
    _getCurrentHeaterCoolerState(dps) {
        ...
        switch (dps['101']) {
            ...
            default:
                this.currentCmd = Characteristic.TargetHeaterCoolerState.AUTO;

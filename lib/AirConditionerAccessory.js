...
class AirConditionerAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        if (!this.device.context.noCool) _validTargetHeaterCoolerStateValues.unshift('1');
        if (!this.device.context.noHeat) _validTargetHeaterCoolerStateValues.unshift('2');

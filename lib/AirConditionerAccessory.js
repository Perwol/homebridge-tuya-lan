...
class AirConditionerAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        fs.watchFile(statusNightModeFile, { interval: 500 }, (curr, prev) => {
            ...
            } while(nightModeReq !== this.nightModeStatus);
        });

        fs.watchFile(statusTimerFile, { interval: 500 }, (curr, prev) => {
            ...
            } while(this.currentTimer !== statusTimerReq);
        });
    }

...
class AirConditionerAccessory extends BaseAccessory {
    ...
    constructor(...props) {
        ...
        var self = this;
        setTimeout(function () {
            self.mqttClient = new MqttHandler();
            console.log(self.mqttClient.aaa());
            self.mqttClient.setData(self.device.context.name, 'mqtt://' + self.device.context.mqttHost, self.mqttOptions);
